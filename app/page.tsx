    ...
    <main className="min-h-screen bg-sig-dark">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/blog" className="inline-flex items-center gap-2 px-8 py-4 bg-sig-green text-black font-semibold rounded-lg hover:bg-sig-green/90 transition sig-glow">
            시그널에 진입하기 →
          </Link>
        </div>
      </section>
      ...
      <footer className="py-12 px-6 border-t border-white/10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-sm">© 2024 Traffic · Product · AI</p>
        </div>
      </footer>
    </main>
  )
